...
# Brief
This idea was inpired from <https://github.com/adiag321/CRM-Analysis-for-Marketing-data> with slightly modyfying the parameters and tried to analyzing different features in the dataset. Some of the work done is given below where we: 
